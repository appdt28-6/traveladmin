<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "UPDATE opcionespaquete set descripcion = ?, costo = ? WHERE id_opcion = ? and id_evento = ?";
			$q = $pdo->prepare($sql);
		...
		$pdo = Database::connect();
		$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql = "SELECT * FROM opcionespaquete where id_opcion= ? and id_evento= ? ";
		$q = $pdo->prepare($sql);
			...
			<div class="content-page">
				<!-- Start content -->
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Listado de Trasportes para <?php include ('eventoheader.php');?></h4>
								<ol class="breadcrumb">
                                    <li>
                                        <a href="#">Trasportes</a>
                                    </li>
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title"><b>Opciones de trasporte</b></h4>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" action="editopc.php?event=<?php echo $event;?>&&hab=<?php echo $hab;?>" method="post" role="form">                                    
