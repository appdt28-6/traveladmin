<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO congreso (id_evento,costo) values(?,?)";
			$q = $pdo->prepare($sql);
			$q->execute(array($event,$costo));
			Database::disconnect();
			...
			<div class="content-page">
				<!-- Start content -->
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-sm-12">
								<h4 class="page-title">Info de congreso</h4>
								<!--<ol class="breadcrumb">
									<li>
										<a href="#">Ubold</a>
									</li>
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title"><b>Agregar la infomación de congreso</b></h4>
