                                ...
                                <div class="card-box">
                                 <br>
                                    <table id="datatable" class="table table-striped table-bordered">
                                            ...
                                            <?php
                                            include('connect.php');
                                            $query="SELECT Clientes.nombre as nombre,Clientes.ap as ap,Clientes.am as am ,Clientes.email as email,Clientes.tel as tel,Clientes.cel as cel,Clientes.gen as gen,Clientes.fn as fn,Clientes.edad as edad,Clientes.calle as calle,Clientes.numero as numero,Clientes.col as col,Clientes.mun as mun,Clientes.cp as cp,Clientes.estado as estado,
                                            ...
                                            coordinador.nombre as coord FROM Clientes inner join datos_medicos on Clientes.id_cliente=datos_medicos.id_cliente 
