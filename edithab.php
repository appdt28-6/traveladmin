<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "UPDATE habitacion set descr = ?, costo = ? WHERE id_hab = ? and id_evento = ?";
			$q = $pdo->prepare($sql);
		...
		$pdo = Database::connect();
		$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
		$sql = "SELECT * FROM habitacion where id_hab= ? and id_evento= ? ";
		$q = $pdo->prepare($sql);
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" action="edithab.php?event=<?php echo $event;?>&&hab=<?php echo $hab;?>" method="post" role="form">                                    
