<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$q = $pdo->prepare($sql);
			$q->execute(array($desc,$costo,$hab,$event));
			Database::disconnect();
				...
				<!-- Start content -->
					...
					<div class="container">
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title"><b>Opciones de Pago</b></h4>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" action="editpago.php?event=<?php echo $event;?>&&hab=<?php echo $hab;?>" method="post" role="form">                                    
