<?php 
	...
	if ( !empty($_POST)) {
		...
		if ($valid) {
			...
			$sql = "INSERT INTO extrapaq (id_evento,desc,costo) values(?,?,?)";
			$q = $pdo->prepare($sql);
				...
				<!-- Start content -->
					...
					<div class="container">
                        ...
                        <div class="row">
                        	<div class="col-sm-12">
                        		<div class="card-box">
                        			<h4 class="m-t-0 header-title"><b>Agregar todas las opciones extras</b></h4>
                        			...
                        			<div class="row">
                        				<div class="col-md-6">
                        					<form class="form-horizontal" action="newevent.php" method="post" role="form">                                    
